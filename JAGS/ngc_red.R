...
df <- data.frame(y = GCS$Nred, y_err = GCS$Nred_err)
...
save(summaries, file='redsummaries_autorun.Robj')
save(outputs, file='redoutputs_autorun.Robj')
save(Dstats, file='reddstats_autorun.Robj')
