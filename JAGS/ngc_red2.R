...
df <- data.frame(y = GCS$N_GC - GCS$Nblue, y_err = GCS$Nblue_err)
...
save(summaries, file='red2summaries_autorun.Robj')
save(outputs, file='red2outputs_autorun.Robj')
save(Dstats, file='red2dstats_autorun.Robj')
